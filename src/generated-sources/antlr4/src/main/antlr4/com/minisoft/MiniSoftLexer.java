...
public class MiniSoftLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "LET", "DEFINE", "CONST", 
			"IF", "THEN", "ELSE", "DO", "WHILE", "FOR", "FROM", "TO", "STEP", "INPUT", 
			"OUTPUT", "INT", "FLOAT_TYPE", "AND", "OR", "INTEGER", "FLOAT", "IDENTIFIER", 
			"STRING", "SIGN", "LETTER", "DIGIT", "SINGLE_LINE_COMMENT", "MULTI_LINE_COMMENT", 
			"WS"
		};
	}
	...
	public MiniSoftLexer(CharStream input) {
		super(input);
